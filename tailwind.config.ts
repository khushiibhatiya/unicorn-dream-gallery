  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-slow": { "0%,100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-30px)" } },
        "sparkle": { "0%,100%": { opacity: "0", transform: "scale(0)" }, "50%": { opacity: "1", transform: "scale(1)" } },
        "drift": { "0%": { transform: "translate(0,100vh) rotate(0deg)", opacity: "0" }, "10%": { opacity: "1" }, "90%": { opacity: "1" }, "100%": { transform: "translate(40px,-10vh) rotate(360deg)", opacity: "0" } },
